...
Generated: 2026-09-24 15:12 UTC. 17 blocking, 9 owed, 0 after the deadline, 7 unverified.
...
| [96](https://github.com/icepack/ismip7/issues/96) | output: acabf and libmassbffl are means over part of a pixel, so the organisers' sums overcount them | needs-run | group | n/a | verified open |
...
| [97](https://github.com/icepack/ismip7/issues/97) | output: the native scalars sum map-plane area, and the organisers' tool sums true area | needs-run | group | n/a | verified open |
...
| [98](https://github.com/icepack/ismip7/issues/98) | submission: ship params.nc with the model's densities | needs-check | group | n/a | verified open |
