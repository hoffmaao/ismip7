...
| `ISMIP7_OBS_DATA_ROOT` | BedMachine, MEaSUREs velocity, and RACMO observational-data root, and the dH/dt cache; name it in a site file when these files do not live beside the code | `<repo>/antarctica/data` |
