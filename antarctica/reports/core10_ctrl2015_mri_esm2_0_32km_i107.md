# Core 10: ctrl2015_mri_esm2_0_i107 (32 km)

- date: 2026-09-24
- git: 700a846
- log: `../logs/ismip7_fwd_10609210.out`
- timeseries: `results/ctrl2015_mri_esm2_0_i107_32000_timeseries.csv` (gitignored; this report is the tracked record)
- observational audit: ON TRACK
- SMB climatology pool: none reported in `../logs/ismip7_fwd_10609210.out` (expected for a CTRL running on the RACMO climatology, which builds no ESM pool)
...
ISMIP7_RESTART=/N/project/ice_rheology/ISMIP7/antarctica/results/hist_mri_esm2_0_i32_32000_final.h5
ISMIP7_RUN_TAG=i107
...
--- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---
2015.1 | 57011.088863 | 23696440.19 | 2457.6109 | 990.5769 | 1654.8544 | 0.0518 | 4.9546 | 0.0000 | 594.2054 | 0 | 0 | 0
2055.9 | 57066.472316 | 23714443.85 | 2457.6109 | 998.3590 | 1645.3872 | 0.0748 | 4.8507 | -0.0000 | 594.2054 | 0 | 0 | 0
2096.8 | 57120.582102 | 23732244.86 | 2457.6109 | 1020.8838 | 1644.5544 | 0.0702 | 5.5158 | -0.0000 | 594.2054 | 0 | 0 | 0
2137.6 | 57173.130310 | 23750156.71 | 2457.6109 | 1030.2296 | 1652.6166 | 0.0753 | 5.8587 | 0.0000 | 594.2054 | 0 | 0 | 0
2178.5 | 57223.910812 | 23767966.17 | 2457.6109 | 1002.5239 | 1663.3111 | 0.0812 | 5.9662 | 0.0000 | 594.2054 | 0 | 0 | 0
2219.3 | 57273.866528 | 23784741.21 | 2457.6109 | 1036.6943 | 1672.1756 | 0.0813 | 5.9593 | 0.0000 | 594.2054 | 0 | 0 | 0
2260.2 | 57323.233931 | 23801431.84 | 2457.6109 | 1040.7334 | 1675.9127 | 0.0903 | 5.9233 | -0.0000 | 594.2054 | 0 | 0 | 0
2301.0 | 57371.059673 | 23817991.88 | 2457.6109 | 1014.1251 | 1675.5228 | 0.0878 | 6.0906 | -0.0000 | 594.2054 | 0 | 0 | 0

## Observational audit

```
ISMIP6-track audit: ctrl2015_mri_esm2_0_i107_32000_timeseries.csv
  2860 steps, 2015.1->2301.0, dt=0.1 yr

  quantity                      run   obs/ISMIP6 envelope    verdict
  SMB                        2457.6   [ 2000.0,  2900.0] Gt/yr     PASS
  shelf basal melt           1022.2   [  600.0,  1800.0] Gt/yr     PASS
  front discharge            1661.3   [  700.0,  2400.0] Gt/yr     PASS
  dM/dt (post-2016)           425.2   [ -400.0,   200.0] Gt/yr     WARN
  dVAF/dt (post-2016)           1.3   [   -2.0,     2.0] mm SLE/yr PASS
  budget residual               0.0   [   -0.5,     0.5] Gt/yr     PASS
  no discharge runaway       1681.8   [yr-median < 6000, growth<1.5x for 2 yr] PASS
