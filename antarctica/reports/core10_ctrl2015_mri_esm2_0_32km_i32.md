# Core 10: ctrl2015_mri_esm2_0_i32 (32 km)

- date: 2026-09-24
- git: 6af8a6a
- log: `../logs/ismip7_fwd_10604858.out`
- timeseries: `results/ctrl2015_mri_esm2_0_i32_32000_timeseries.csv` (gitignored; this report is the tracked record)
- observational audit: ON TRACK
- SMB climatology pool: none reported in `../logs/ismip7_fwd_10604858.out` (expected for a CTRL running on the RACMO climatology, which builds no ESM pool)
...
--- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---
2015.1 | 57011.088863 | 23696437.99 | 2457.6109 | 1011.3575 | 1654.7544 | 0.0587 | 4.8301 | 0.0000 | 594.2054 | 0 | 0 | 0
2055.9 | 57066.571045 | 23714151.91 | 2457.6109 | 1025.0601 | 1637.6595 | 0.0811 | 4.7723 | -0.0000 | 594.2054 | 0 | 0 | 0
2096.8 | 57120.197926 | 23731780.52 | 2457.6109 | 1048.7767 | 1635.8544 | 0.0774 | 5.3177 | 0.0000 | 594.2054 | 0 | 0 | 0
2137.6 | 57172.780878 | 23749547.10 | 2457.6109 | 1026.2460 | 1642.4587 | 0.0808 | 5.8173 | -0.0000 | 594.2054 | 0 | 0 | 0
2178.5 | 57223.517510 | 23767262.27 | 2457.6109 | 1031.4876 | 1647.5271 | 0.0882 | 5.7876 | -0.0000 | 594.2054 | 0 | 0 | 0
2219.3 | 57272.782869 | 23784051.63 | 2457.6109 | 1052.6989 | 1661.6694 | 0.0874 | 5.8339 | -0.0000 | 594.2054 | 0 | 0 | 0
2260.2 | 57322.150688 | 23800672.64 | 2457.6109 | 1047.1786 | 1666.7045 | 0.0971 | 5.7560 | 0.0000 | 594.2054 | 0 | 0 | 0
2301.0 | 57369.929963 | 23817096.00 | 2457.6109 | 1044.2107 | 1666.3495 | 0.0939 | 5.9206 | 0.0000 | 594.2054 | 0 | 0 | 0

## Observational audit

```
ISMIP6-track audit: ctrl2015_mri_esm2_0_i32_32000_timeseries.csv
  2860 steps, 2015.1->2301.0, dt=0.1 yr

  quantity                      run   obs/ISMIP6 envelope    verdict
  SMB                        2457.6   [ 2000.0,  2900.0] Gt/yr     PASS
  shelf basal melt           1033.6   [  600.0,  1800.0] Gt/yr     PASS
  front discharge            1651.8   [  700.0,  2400.0] Gt/yr     PASS
  dM/dt (post-2016)           422.1   [ -400.0,   200.0] Gt/yr     WARN
  dVAF/dt (post-2016)           1.3   [   -2.0,     2.0] mm SLE/yr PASS
  budget residual               0.0   [   -0.5,     0.5] Gt/yr     PASS
  no discharge runaway       1674.0   [yr-median < 6000, growth<1.5x for 2 yr] PASS
