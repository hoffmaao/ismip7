...
# nots_*.sbatch scripts still have blank, plus the deepsC partition limits.
# It only reads; it submits nothing and changes nothing.
echo "===== 1. slurm account (fills NOTS_ACCOUNT) ====="
...
echo; echo "===== 5. is Firedrake already built anywhere? (fills NOTS_FIREDRAKE) ====="
...
echo; echo "===== 6. toolchain modules available (fills NOTS_MODULES) ====="
