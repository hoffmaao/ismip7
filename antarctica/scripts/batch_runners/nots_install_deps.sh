...
# packages. Run ONCE on a login node after nots_build_firedrake.sbatch:
#
#   bash antarctica/scripts/batch_runners/nots_install_deps.sh
#
...
. /projects/ah301/ismip7/antarctica/scripts/batch_runners/nots_env.sh
nots_activate
